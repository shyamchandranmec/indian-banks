        ...
        <div class="row">
            <div class="col-md-4">
                <div class="row">
                    <div class="col-md-12 ">
                        <div class="bank-list">
                            <select class="form-control" onchange="{this.bankSelected}" name="bank">
                                <option value="" disabled selected>Select your option</option>
                                <option each={item in this.banks} value="{item.bankId}">{item.bankName}</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        <input class="form-control" id="city" type="text" name="city-input" value="{this.selectedCity}">
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                <div class="jumbotron search-result" each={item in this.branches}>
                    <b>Bank Name </b>{item.bank_name}
                    <br>
                    <b>IFSC </b>{item.ifsc}
                    <br>
